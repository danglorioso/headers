      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Professional file header templates for your code. Click to copy and paste into your files.
          </p>
        </div>
        ...
        <div className="text-center mt-12 py-8 border-t border-gray-200 dark:border-slate-700">
          <p className="text-gray-600 dark:text-gray-400">
            Choose the template that best fits your project needs. Remember to replace placeholders with your actual information!
          </p>
        </div>
      </div>
    </div>
